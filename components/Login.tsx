  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-900 py-20 px-4">
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-primary/60 to-slate-900/90"></div>
      </div>
          ...
          <div className="p-10 md:p-14">
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 mb-6" onClick={() => setView('global')}>
                <div className="w-12 h-12 bg-primary rounded-2xl flex items-center justify-center text-white text-2xl font-bold shadow-lg cursor-pointer">I</div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="animate-fadeIn">
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      required
                      className="w-full pl-14 pr-6 py-4 rounded-2xl bg-slate-50 border border-slate-200 focus:ring-4 focus:ring-primary/20 focus:border-primary outline-none transition-all font-medium"
              ...
              <button
                type="submit"
                className="w-full py-5 bg-primary text-white rounded-2xl font-black text-lg shadow-xl shadow-primary/30 hover:bg-primary transition-all transform hover:scale-[1.02] active:scale-95"
              >
